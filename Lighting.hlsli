...
//helper defines and consts for IBL
...
// ----------------------------------------------------
// Check the signature for the DiffuseEnergyConserve() function that is already defined in Lighting.hlsli:
// - Ensure the diffuse parameter is a float3 instead of a float
// - That’s it! No other changes are necessary as a result of this one, as any existing calls will implicitly cast correctly
#endif